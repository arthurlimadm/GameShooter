...
export const AnimateCanvas = (canvas: HTMLCanvasElement, context:CanvasRenderingContext2D, gyroscope: IGyroscope, shooted:IPosition | false, Sprites: Sprite[]):Sprite[]=>{
