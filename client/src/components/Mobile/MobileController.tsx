...
export const MobileController = ()=>{
    ...
    const [gyroscope, setGyroscope] = useState<IGyroscope>({alpha: 0, gamma: 0, beta:0})
    ...
    const shoot = ()=>{
        ...
        SocketIO.socket.emit('Shot', {userID: id, alpha: gyroscope.alpha, beta: gyroscope.beta, gamma: gyroscope.gamma})
    }
